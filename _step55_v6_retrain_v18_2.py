...
Output:
  ...
  _v18_2_v6_inline.js (compact JS array, HTML embed için)
"""
...
data = json.load(open('working/_v18_2_dataset.json', encoding='utf-8'))
...
out_subset = 'working/_v18_2_v6_subset.json'
