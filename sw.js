...
// Faz2-Batch2 invert-MUADIL (2026-05-25): 4 invert grubu MUADIL kartinin fark+detay metni yeniden
// yazildi (invert2 GU 324/32°L + invert3 GU 324/60°L profil + gramaj guncel; DEF objelerine dokunulmadi).
// bump v131-124 -> v131-125.
...
// Faz2-Batch5 dex+maltodex-MUADIL (2026-05-25): 5 dex + 3 maltodex MUADIL kartinin fark+detay metni
// yeniden yazildi (dex GU 350 + maltodex GU 334 fermente olmaz profil; DEF objelerine dokunulmadi).
// bump v131-127 -> v131-128.
...
// HTML degisti (Sprint BA) -> KURAL 12.3 CACHE_VERSION bump v131-413 -> v131-414.
// HTML degisti (Sprint BB) -> KURAL 12.3 CACHE_VERSION bump v131-414 -> v131-415.
// HTML degisti (Sprint BC) -> KURAL 12.3 CACHE_VERSION bump v131-415 -> v131-416.
// HTML degisti (Sprint BE1) -> KURAL 12.3 CACHE_VERSION bump v131-416 -> v131-417.
...
const CACHE_VERSION='bm-cache-v131-422';   // HTML — her deploy'da bump, eskisi silinir (taze HTML sart)
