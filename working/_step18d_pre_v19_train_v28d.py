...
DATA_PATH = 'working/_v28d_aliased_dataset.json'
...
m.get_booster().save_model('working/_v19_v28d_model_14cat.json')
sz = os.path.getsize('working/_v19_v28d_model_14cat.json') / 1024
print(f'\nWrote working/_v19_v28d_model_14cat.json ({sz:.0f} KB)', flush=True)
with open('working/_v19_v28d_label_encoder_14cat.json', 'w', encoding='utf-8') as f:
...
ms.get_booster().save_model('working/_v19_v28d_model_slug.json')
sz_s = os.path.getsize('working/_v19_v28d_model_slug.json') / 1024
print(f'\nWrote working/_v19_v28d_model_slug.json ({sz_s:.0f} KB)', flush=True)
with open('working/_v19_v28d_label_encoder_slug.json', 'w', encoding='utf-8') as f:
