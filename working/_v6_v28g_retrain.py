...
DATASET = Path('C:/Users/Kaan/brewmaster/working/_v28g_aliased_dataset.json')
ARCH = Path('C:/Users/Kaan/brewmaster/working/archive/v6_step6_v28g')
...
SLUG_TO_NEW_CLUSTER = {
    ...
    'roggenbier':'wheat',
    # CLUSTER 13: AMERICAN_WHEAT_WINE -> strong_ale (KAAN KARAR 1)
