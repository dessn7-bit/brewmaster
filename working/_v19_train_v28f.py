...
m.get_booster().save_model('working/_v19_v28f_model_14cat.json')
sz = os.path.getsize('working/_v19_v28f_model_14cat.json') / 1024
print(f'\nWrote working/_v19_v28f_model_14cat.json ({sz:.0f} KB)', flush=True)
with open('working/_v19_v28f_label_encoder_14cat.json', 'w', encoding='utf-8') as f:
...
print(f'Training V19 slug V28f (Senaryo 4: depth=4, n_est=350, subsample=0.6, colsample=0.6, gamma=0.5, mcw=4)...', flush=True)
...
ms.get_booster().save_model('working/_v19_v28f_model_slug.json')
sz_s = os.path.getsize('working/_v19_v28f_model_slug.json') / 1024
print(f'\nWrote working/_v19_v28f_model_slug.json ({sz_s:.0f} KB)', flush=True)
with open('working/_v19_v28f_label_encoder_slug.json', 'w', encoding='utf-8') as f:
